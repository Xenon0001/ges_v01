"""
Lista de estudiantes a seleccionar ( Simplemente copio y pego la interfaz de la sección de lista de 
estudiantes en el Top level)

Lógica:
Del estudiante seleccionado haré un select con la información que necesite
"""
import tkinter as tk
import ttkbootstrap as ttk
from ttkbootstrap.constants import *

class ListaEstudiantes(ttk.Toplevel):
